...
const Editor = ({ setFormId, setFormStatus }) => {
  ...
  return (
    <div>
      <h1 className="text-xl md:text-3xl font-bold text-center my-5 text-black">
        Edit Your Form With Form Build
      </h1>
      <form
      ...
      >
        ...
        <div className="mb-20 bg-light-pink p-9 rounded-lg">
          <div className="flex gap-2">
            <h3 className="text-xl font-semibold text-black uppercase mb-3">
              Question 1
            </h3>
            <Tooltip
              content={
                <div className="w-80">
                  ...
                  >
                    First write category name. Then Write items for each
                    category and select the category name.
                  </Typography>
                </div>
              }
            >
          ...
          <div className="flex flex-col md:flex-row gap-40">
            <div className="">
              <h4 className="text-lg mb-2 text-black">Category</h4>
              <div className=" flex flex-col gap-2">
                <input
                  {...register("category1", { required: false })}
                  name="category1"
                  id="category1"
                  className=" outline-none border border-cavern-pink p-2 rounded text-black"
                  type="text"
                ...
                <input
                  ...
                  name="category2"
                  id="category2"
                  className=" outline-none border border-cavern-pink p-2 rounded"
                  type="text"
            ...
            <div className="">
              <h4 className="text-lg mb-2 text-black">
                Item ------------------------------------------ Belongs to
              </h4>
              <div className=" flex flex-col gap-2">
                {categories.length === 0 ? (
                  <div className="flex flex-col md:flex-row gap-4 md:gap-20 justify-between items-start">
                    <input
                      ...
                      placeholder="Item1"
                    />
                    <select className="border border-cavern-pink p-3 rounded text-black outline-none">
                      ...
                      return (
                        ...
                        >
                          ...
                          <select
                            ...
                            className="border border-cavern-pink p-3 rounded text-gray-600 outline-none"
                          >
        ...
        {/* {Cloze Questions} */}
        <div className="bg-light-pink p-9 rounded-lg">
          <div className="flex gap-2">
            <h3 className="text-xl font-semibold text-black uppercase mb-3">
              Question 2
            </h3>
              ...
              content={
                <div className="w-80">
                  ...
                  <Typography
                    ...
                    className="font-normal opacity-80"
                  >
                    First write a sentence in the sentence box. Then select a
                    word to make it as a fill in the box type word.
                  </Typography>
                </div>
              }
            >
          ...
          <div>
            ...
            <textarea
              cols={50}
              rows={1}
              className="outline-none border border-cavern-pink p-2 rounded w-full md:w-[50%]"
        ...
        {/* {MCQ questions} */}
        <div className="mt-20 relative bg-light-pink p-2 md:p-9 rounded-lg">
          <div className="flex gap-2">
            <h3 className="text-xl font-semibold text-black uppercase mb-3">
              Question 3
            </h3>
              ...
              content={
                <div className="w-80">
                  ...
                  <Typography
                    ...
                    className="font-normal opacity-80"
                  >
                    Write a paragraph then make question and set options for the
                    question
                  </Typography>
                </div>
              }
          ...
          <h4 className="text-black">Your Passage:</h4>
          <span className=" absolute right-0 md:right-8 bottom-2 md:top-44">
            <Tooltip
            ...
            >
              <IconButton
                onClick={() => setNumOfMcqQuestions([...numOfMcqQuestions, 1])}
              >
                <FaPlus></FaPlus>
              </IconButton>
            </Tooltip>
          ...
          <textarea
            ...
            className=" outline-none border border-cavern-pink p-4 rounded w-full md:w-[60%]"
            cols="60"
            rows="5"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-11">
            {numOfMcqQuestions.map((num, index) => {
              return (
                <div
                  key={index}
                  className="mt-10 bg-light-pink p-3 md:p-9 rounded-lg"
                >
                  <h4 className=" text-lg  text-black">
                    MCQ question number: {index + 1}
                  </h4>
                  <input
                    {...register(`Mcq${index + 1}`, { required: false })}
                    className="md:w-[400px] outline-none border border-cavern-pink p-2 rounded"
                    type="text"
        ...
        <div className="mt-5 mb-20">
          <Button
            ...
            onClick={() => setFormStatus("notSubmited")}
          >
            Save Changes
          </Button>
        </div>
